// PCH for E:\Program Files (x86)\Unreal\UE_4.25\Engine\Source\Runtime\Engine\Public\EngineSharedPCH.h
#define IS_PROGRAM 0
#define UE_EDITOR 1
...
#include "E:/Program Files (x86)/Unreal/UE_4.25/Engine/Source/Runtime/Engine/Public/EngineSharedPCH.h"
